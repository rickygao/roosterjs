...
import { setSelectionIndentation } from '../../../lib/modelApi/block/setSelectionIndentation';

describe('indent', () => {
    it('Empty group', () => {
        const group = createContentModelDocument();

        const result = setSelectionIndentation(group, 'indent');
    ...
    it('Group with selected indented paragraph, outdent with different length', () => {
        ...
        const result = setSelectionIndentation(group, 'indent', 15);
        expect(group).toEqual({
            blockGroupType: 'Document',
            blocks: [
                {
...
describe('outdent', () => {
    it('Empty group', () => {
        ...
        const result = setSelectionIndentation(group, 'outdent');
    ...
    it('Group with selected indented paragraph, outdent with different length', () => {
        ...
        const result = setSelectionIndentation(group, 'outdent', 15);
        expect(group).toEqual({
            blockGroupType: 'Document',
            blocks: [
                {
